...
;; Activities: Use machine-specific activities directory
;; This overrides the default state/activities/default/
;; Note: persist.el appends the symbol name automatically to create the file
