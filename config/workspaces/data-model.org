...
The data layer treats =:home= as an opaque string; validation of its
shape (absolute path, directory exists, basename equals =:name=) is the
responsibility of the caller and the persistence boundary.  See
register/invariant/home-required-no-floating-workspaces and
