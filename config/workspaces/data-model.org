...
construction.  Multiple call sites (=workspace-sessions-dir=,
=workspace--scaffold-initial-session=, =workspace-scaffold= stage
4) all need this exact path; routing through a single helper makes
the layout vocabulary (subdirectory name) editable in one place
(cycle 2 architect finding =arch-cycle-20260525-213500-05=).
