...
Note: The :nesting-depth metadata should be added by the caller
(typically the recursive analyzer) when depth tracking information
is available. This function only manages the :indirect flag.
