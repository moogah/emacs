...
The parser is intentionally generic and not tied to any specific use case (like
gptel), making it reusable for shell script analysis, command validation, or
other tooling.
