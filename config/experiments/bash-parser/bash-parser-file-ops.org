...
*** Extract Pattern Flow Operations

Create operations for outer commands consuming patterns from substitutions.
...
*** Helper: Infer Operation From Command

Helper function to infer file operation type from command name and file context.
