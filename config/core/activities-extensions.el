...
By default, creates both org-roam document and gptel session."
  ["Configuration"
...
Uses the activity name stored in `activities-ext--current-activity-name'."
  ...
  (let* ((activity-name activities-ext--current-activity-name)
         ...
         ;; Default to creating both org-roam and gptel unless explicitly skipped
    ...
    (message "DEBUG: create-gptel=%S" create-gptel)
