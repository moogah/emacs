#+title: GPTEL Filesystem Tools
#+author: Jeff Farr
#+property: header-args:emacs-lisp :tangle filesystem-tools.el
#+auto_tangle: y

* Introduction
This file defines gptel tools for filesystem operations that can be used by LLMs
to interact with the Emacs environment.
