...
extracted from the preset file during registration. The legacy
:org-roam-patterns key is no longer extracted; see
...
ignored key, and the key is dropped from the extracted scope plist."
