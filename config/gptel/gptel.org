...
3. Registry - Global session registry and initialization
4. Metadata - Metadata persistence and tree operations
5. Tracing - Agent execution tracing
6. Hooks - Advice functions and auto-save
7. Browser - Session browsing and reconstruction
8. Branching - Branch creation and management
