...
Five-stage pipeline with early exit on failure. Commands are validated by the
file operations they perform and the cloud authentication patterns they match —
there is no command-name deny list.
