...
* Scope Plan Location Convention

Tools locate scope plans using a simple filesystem convention:
...
use this to find the scope plan in the same directory as the context file.
#+end_src
