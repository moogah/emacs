...
#+begin_example
Layer 1: Contract unit tests (config/core/contracts/test/)
...
| bash-parser plugins | Producer (semantics) | =config/bash-parser/analysis/bash-parser-plugins.el= |
| contract validators | Boundary check | =config/core/contracts/contract-bash-parser.el= |
