...
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-constants.el" jf/emacs-dir))
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-logging.el" jf/emacs-dir))

;; Load filesystem utilities before other modules (registry and hooks depend on it)
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-filesystem.el" jf/emacs-dir))

;; Load session modules in dependency order
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-registry.el" jf/emacs-dir))
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-metadata.el" jf/emacs-dir))
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-tracing.el" jf/emacs-dir))

;; Load subagent integration (must be before hooks to provide helper functions)
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-subagent.el" jf/emacs-dir))

;; Load hooks module (depends on subagent for helper functions)
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-hooks.el" jf/emacs-dir))
...
(jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-commands.el" jf/emacs-dir))
...
;; (jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-branching.el" jf/emacs-dir))
;; (jf/load-module (expand-file-name "config/gptel/sessions/jf-gptel-session-transient.el" jf/emacs-dir))
