...
Helper functions for detecting session file format (org-mode vs markdown).
Used by branching operations to inherit parent format and by Local Variables writing.

** Detect Session File Format
...
** Get Session File Extension String
