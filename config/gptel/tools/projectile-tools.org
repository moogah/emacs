...
Find all files in the project containing a specific string or pattern.
...
** list_test_files
Get all test files in the project based on project type conventions.
...
* File Relationship Tools

** find_related_files
Find all semantically related files (tests, implementations, headers, etc.) for a given file.
