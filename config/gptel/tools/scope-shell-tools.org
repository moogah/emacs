...
* V4 Schema Support Functions

Functions for loading and validating scope.yml v4 schema with operation-specific paths, cloud config, and security settings.
...
* Validation Pipeline Stage 4: File Operations

Stage 4 validates file operations extracted from bash commands against operation-specific path permissions.
...
* Stage 5: Cloud Authentication Detection and Enforcement
