...
├── sessions/              - session management modules
...
4. Verify overlay appears in parent buffer
5. Monitor overlay updates during tool calls
6. Check final result returned to parent
7. Verify session.org contains full conversation
