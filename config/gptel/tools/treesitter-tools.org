...
Tools provided:
- get_node_at_position, get_node_info, get_syntax_tree
- list_functions, list_classes, list_imports
- extract_definition, query_nodes, find_nodes_by_type
- find_nodes_in_range, get_node_context, get_scope_structure
- list_treesitter_languages, check_treesitter_parser
