...
- get_node_context: Surrounding code context"
 ...
 :function (lambda (filepath position show-children)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath)))
...
- query_nodes: Pattern-based extraction"
 ...
 :function (lambda (filepath depth start-line end-line)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath))
...
- Read tool: See full file content"
 ...
 :function (lambda (filepath include-signatures limit)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath))
...
- find_definition [ggtags]: Cross-file class location"
 ...
 :function (lambda (filepath include-members include-inheritance limit)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath))
...
- projectile tools: Locate imported files in project"
 ...
 :function (lambda (filepath group-by-source)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath)))
...
- list_functions/list_classes: Standard semantic extraction"
 ...
 :function (lambda (filepath query limit)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath))
...
- get_syntax_tree: Discover available node types"
 ...
 :function (lambda (filepath node-types limit)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath))
...
- get_syntax_tree: Structural view of range"
 ...
 :function (lambda (filepath start-line end-line node-type)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath)))
...
- get_syntax_tree: Broader structural view"
 ...
 :function (lambda (filepath position show-siblings)
             (condition-case err
                 (with-temp-buffer
                   (insert-file-contents filepath)
                   (let* ((language (gptel-treesitter--detect-language filepath)))
