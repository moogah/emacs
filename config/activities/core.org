#+title: Activities Extensions - Core
#+author: Jeff Farr
#+property: header-args:emacs-lisp :tangle core.el
#+auto_tangle: y

* Introduction

Core functionality for activities-extensions including data management, utilities,
lifecycle hooks, and utility commands.
...
** Buffer Activity Lookup

Functions for determining which activity a buffer belongs to.
