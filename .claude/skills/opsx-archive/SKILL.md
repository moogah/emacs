---
name: opsx-archive
description: Archive a completed change in the experimental workflow. Use when the user wants to finalize and archive a change after implementation is complete, moving it from openspec/changes/ to the archive subdirectory.
---
